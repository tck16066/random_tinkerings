...
void add4(int &x)  {x += 4;  throw exception_4();}
void add5(int &x)  {x += 5;  throw exception_5();}
void add6(int &x)  {x += 6;  throw exception_6();}
void add7(int &x)  {x += 7;  throw exception_7();}
void add8(int &x)  {x += 8;  throw exception_8();}
void add9(int &x)  {x += 9;  throw exception_9();}
void add10(int &x) {x += 10; throw exception_10();}
void add11(int &x) {x += 11; throw exception_11();}
void add12(int &x) {x += 12; throw exception_12();}
void add13(int &x) {x += 13; throw exception_13();}
void add14(int &x) {x += 14; throw exception_14();}
void add15(int &x) {x += 15; throw exception_15();}
void add16(int &x) {x += 16; throw exception_16();}
